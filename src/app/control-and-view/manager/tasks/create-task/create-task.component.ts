...
export class CreateTaskComponent implements OnInit {
  ...
  constructor(private router: Router, private taskServ: TaskService, private WorkOrderServiceService: WorkOrderServiceService) { }
  ...
  createTask() {
    ...
    // } 
      ...
      //     alert("Please provide time!");
      //   }
      //   else if (this.convert_DT(this.TaskStartDate) < this.convert_DT(new Date())) {
      ...
      //               };
      //               this.WorkOrderServiceService.addWorkOrderWithOutEqup(this.taskCreation).subscribe(res => {
  ...
  //                     IsSnapshot: this.Gps_SnapShot
  //                   };
  //                   this.WorkOrderServiceService.addWorkOrderEqup(this.taskCreation).subscribe(res => {
  //                     alert("Work-order created successfully");
  //                     this.router.navigate(['/ManagerDashBoard', { outlets: { ManagerOut: ['viewTask'] } }]);
  //                   });
  //                 });
  ...
  withoutequip_wo() {
    ...
    //   }
    // } else 
    if (this.isRecurring == true && this.dailyrecurring == true) {
      var timeset = [];
      var timeset_corr = [];
      timeset = this.timetable.times;
      for (var i = 0; i < timeset.length; i++) {
