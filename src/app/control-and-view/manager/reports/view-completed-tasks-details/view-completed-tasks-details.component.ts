...
@Component({
  selector: 'app-view-completed-tasks-details',
  templateUrl: './view-completed-tasks-details.component.html',
  styleUrls: ['./view-completed-tasks-details.component.scss']
})
export class ViewCompletedTasksDetailsComponent implements OnInit {
  from;
  to;
  empKey;
  wotypeKey;
  ...
  ngOnInit() {
    ...
    this.loading = true;
    this.taskServ.getCompletedTaskDetails(this.from, this.to, this.empKey, this.wotypeKey, this.org)
      .subscribe((data: any[]) => {
