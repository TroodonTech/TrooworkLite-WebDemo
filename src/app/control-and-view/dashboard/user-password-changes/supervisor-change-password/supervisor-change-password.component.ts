...
@Component({
  selector: 'app-supervisor-change-password',
  templateUrl: './supervisor-change-password.component.html',
  styleUrls: ['./supervisor-change-password.component.scss']
})
export class SupervisorChangePasswordComponent implements OnInit {
